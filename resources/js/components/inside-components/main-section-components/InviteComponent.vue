    ...
    <div class="col-md-8">
        ...
        <div class="game-cards row">
            ...
            <div class="game-card col-6">
                ...
                <button class="join-button" @click="showSingModal">
                    Играть
                </button>
            </div>
            <div class="game-card col-6">
                ...
                <button class="join-button" @click="showTeamModal">
                    Играть
                </button>
            </div>
        </div>
        <modal-component v-show="isModalVisible" @close="closeModal" :text='text' :user='user'></modal-component>
    </div>
</template>
